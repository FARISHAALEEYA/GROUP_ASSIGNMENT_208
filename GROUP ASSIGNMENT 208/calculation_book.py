...
def collect_data():
    book_category = book_category_var.get()
    ...
    total_price = (prices[book_category] * packs)
    ...
    sql = "INSERT INTO user (Book_Category, Book_Pack, Days_Late, Total_Price) VALUES (%s, %s, %s, %s)"
    val = (book_category, packs, days_late,total_price)
...
prices_text.insert(tk.END, "Act:\nPrice: RM100\n\n")
prices_text.insert(tk.END, "Novel:\nPrice: RM35\n\n")
prices_text.insert(tk.END, "Conference:\nPrice: RM60\n\n")
prices_text.insert(tk.END, "Children book:\nPrice: RM15\n\n")
prices_text.insert(tk.END, "Audio book:\nPrice: RM150\n\n")
prices_text.configure(state='disabled')

# Book category Dropdown (Label)
book_category_label = tk.Label(frame, text="Choose Your Book Category", font=("Bodoni MT Black", 12), bg='#FCFFE7')
book_category_label.pack()

# Book category Dropdown
book_category_var = tk.StringVar(root)
book_category_var.set("Select Your Book Category")
book_category_dropdown = tk.OptionMenu(frame, book_category_var, "Act", "Novel", "Conference", "Children book", "Audio book")
book_category_dropdown.config(font=("Times New Roman", 12,))
book_category_dropdown.pack()
